...
(function () {
    ...
    // Daten in src/world/npc-data.js (#11 Zellteilung, Sprint 25)
    const _npcData = window.INSEL_NPC_DATA;
    const NPC_VOICES = _npcData.voices;
    const MAT_ADJECTIVES = _npcData.adjectives;
    const REACTIONS = _npcData.reactions;
    const TEMPLATES = _npcData.templates;

    // Combo-Tracker: besondere Kommentare bei Serien
    let lastMaterial = null;
    let materialStreak = 0;

    const STREAK_COMMENTS = _npcData.streakComments;
