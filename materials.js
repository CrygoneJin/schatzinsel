...
window.INSEL_MATERIALS = {
    ...
    punk:     { emoji: '🤘', label: 'Punk',      color: '#E74C3C', border: '#C0392B' },
    jazz:     { emoji: '🎷', label: 'Jazz',      color: '#2E4053', border: '#1C2833' },
    chiptune: { emoji: '👾', label: 'Chiptune',  color: '#00FF41', border: '#00CC33' },
    reggae:   { emoji: '🟢', label: 'Reggae',    color: '#27AE60', border: '#1E8449' },
    klassik:  { emoji: '🎻', label: 'Klassik',   color: '#F5E6CA', border: '#D4C5A9' },
    blues:    { emoji: '🎸', label: 'Blues',      color: '#2980B9', border: '#1F618D' },
    metal_music: { emoji: '🖤', label: 'Metal', color: '#1A1A1A', border: '#000000' },
    hiphop:   { emoji: '🎤', label: 'HipHop',    color: '#F39C12', border: '#E67E22' },
    techno:   { emoji: '🔊', label: 'Techno',    color: '#8E44AD', border: '#6C3483' },
    country:  { emoji: '🤠', label: 'Country',   color: '#D4AC0D', border: '#B7950B' },
    flamenco: { emoji: '💃', label: 'Flamenco',  color: '#E74C3C', border: '#B03A2E' },
    samba:    { emoji: '🥁', label: 'Samba',      color: '#F1C40F', border: '#D4AC0D' },
    opera:    { emoji: '🎭', label: 'Oper',       color: '#C0392B', border: '#922B21' },
    surf:     { emoji: '🏄', label: 'Surf',       color: '#5DADE2', border: '#2E86C1' },
    lullaby:  { emoji: '🌙', label: 'Wiegenlied', color: '#D2B4DE', border: '#BB8FCE' },
