...
window.INSEL_MATERIALS = {
    ...
    // === TIC-TAC-ZEH (Easter Egg: Toe → Zeh → Juli Zeh, Toe++ → C++) ===
    juli_zeh:     { emoji: '📚', label: 'Juli Zeh',     color: '#8E44AD', border: '#6C3483' },
    cplusplus:    { emoji: '⚙️', label: 'C++',          color: '#2C3E50', border: '#1A252F' },
