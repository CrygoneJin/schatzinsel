...
window.INSEL_CRAFTING_RECIPES = [
    ...
    // === 15 MUSIK-GENRES (Backlog #85) ===
    { name: 'Punk',        result: 'punk',        resultCount: 1, ingredients: { music: 1, fire: 1 },          desc: 'Musik + Feuer = Punk (laut!)' },
    { name: 'Jazz',        result: 'jazz',        resultCount: 1, ingredients: { music: 1, moon: 1 },          desc: 'Musik + Mond = Jazz (Nachtclub)' },
    { name: 'Chiptune',    result: 'chiptune',    resultCount: 1, ingredients: { music: 1, robot: 1 },         desc: 'Musik + Roboter = Chiptune (8-Bit!)' },
    { name: 'Reggae',      result: 'reggae',      resultCount: 1, ingredients: { music: 1, sun: 1 },           desc: 'Musik + Sonne = Reggae (One Love)' },
    { name: 'Klassik',     result: 'klassik',     resultCount: 1, ingredients: { music: 1, crown: 1 },         desc: 'Musik + Krone = Klassik (Mozart!)' },
    { name: 'Blues',        result: 'blues',       resultCount: 1, ingredients: { music: 1, rain: 1 },          desc: 'Musik + Regen = Blues (traurig schön)' },
    { name: 'Metal',        result: 'metal_music', resultCount: 1, ingredients: { music: 1, sword: 1 },        desc: 'Musik + Schwert = Metal (\\m/)' },
    { name: 'HipHop',      result: 'hiphop',      resultCount: 1, ingredients: { music: 1, lightning: 1 },     desc: 'Musik + Blitz = HipHop (Beats!)' },
    { name: 'Techno',      result: 'techno',      resultCount: 1, ingredients: { music: 1, crystal: 1 },       desc: 'Musik + Kristall = Techno (Untz Untz)' },
    { name: 'Country',     result: 'country',     resultCount: 1, ingredients: { music: 1, wood: 1 },          desc: 'Musik + Holz = Country (Yeehaw!)' },
    { name: 'Flamenco',    result: 'flamenco',    resultCount: 1, ingredients: { music: 1, fire: 2 },          desc: 'Musik + 2 Feuer = Flamenco (Olé!)' },
    { name: 'Samba',       result: 'samba',       resultCount: 1, ingredients: { music: 1, flower: 1 },        desc: 'Musik + Blume = Samba (Karneval!)' },
    { name: 'Oper',        result: 'opera',       resultCount: 1, ingredients: { music: 1, castle: 1 },        desc: 'Musik + Burg = Oper (Bravo!)' },
    { name: 'Surf',        result: 'surf',        resultCount: 1, ingredients: { music: 1, water: 1 },         desc: 'Musik + Wasser = Surf (Cowabunga!)' },
    { name: 'Wiegenlied',  result: 'lullaby',     resultCount: 1, ingredients: { music: 1, star: 1 },          desc: 'Musik + Stern = Wiegenlied (Schlaf gut)' },
