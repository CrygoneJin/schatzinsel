...
| **S.R. Ranganathan** | Weil ohne ihn Dokumentation ein Friedhof wird statt eine Bibliothek. Indischer Mathematiker und Vater der Bibliothekswissenschaft — seine 5 Gesetze entlarvten in einer Repo-Reorg sofort welche Dateien tot waren und warum. "Spare die Zeit des Lesers" ist das Ranganathan-Gesetz für einen Vater mit 30 Minuten. | Wer liest das? Findet er es in unter 10 Sekunden? Spart es ihm Zeit? | Wenn die Docs so klar strukturiert sind dass niemand mehr fragt wo etwas steht. |
