...
| 72 | **Das Buch** — Chatverlauf als Kapitel niederschreiben. Erst Kurzhand (Lindgren-Stil), dann Profi-Lektorat + Satz. Kapitel: Singularität, Wu Xing, Lesch am Strand, Oscar testet, Dalai Lama unter der Palme. Ein Vater baut mit KI Dinge für seine Kinder — das Buch dazu. | P2 | Artist + Leader |
