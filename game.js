...
(function () {
    ...
    const CODE_EASTER_EGGS = {
        ...
        wood: [
            ...
            '⚛️ "Ich bin ATOM!" ruft ein leuchtender Ball. "Ich bestehe aus ELEKTRONEN!" Tommy: "Klick-klack! Electron? Das ist doch diese — klick-klack! — JavaScript-Sache!" Atom: "Ich war mal berühmt. Dann kam..." *schaut zu VS Code* "...ER."',
            '💎 Sublime sitzt erhaben auf dem Holz. "Ich bin SUBLIME. Ich bin ERHABEN." Nano piepst: "Ich bin 3 KB." Sublime: "Ich koste 99 Dollar." Nano: "Ich bin GRATIS." Vim Wenders: ":wq"',
            '🦓 "ZED!" ruft ein Zebra. "Ich bin der NEUE! Mit KI!" Vim Wenders schaut müde: "1991." Emacs hustet: "1976." Nano flüstert: "1999." Zed: "Aber ICH hab KI!" Alle: "..."',
            '👴 Emacs sitzt im Holzsessel und strickt. "Ich bin ein Betriebssystem dem ein guter Editor fehlt." Vim lacht. Nano versteht den Witz nicht. Kate bringt Tee.',
            '📐 "Ich bin BRACKETS!" ruft eine Klammer. Lisa Lispel dreht sich um: "KLAMMERN?! WO?!" Brackets: "Nein, ich bin ein EDITOR für Web—" Lisa umarmt ihn bereits. "(((Endlich jemand der mich versteht!)))"',
            '🔬 "Ich bin MICRO!" flüstert eine winzige Stimme. "Größer als Nano, kleiner als Vim." Tommy: "Klick-klack! Strg-C, Strg-V! Wie ein NORMALER Mensch!" Vim Wenders schüttelt den Kopf: ":wq"',
            '🎸 Willy Astor schnappt sich eine Holzlatte: "Was macht ein EDITOR im Wald? Er KORRI-GIERT Bäume! Haha! HOLZ-LICH willkommen! Das ist ein EDIT-ORIALES Meisterwerk!" Wigald notiert: "Sublime... erhaben... SUB-LIMINAL!"',
            '🎬 Tommy dreht einen Film über Editoren: "Szene 1: Vim und Emacs — klick-klack! — STREITEN SICH!" Wigald: "Wartet, das ist wie Beatles vs. Stones!" Tommy: "CUT! Szene 2: Nano weint in der Ecke!" Krappweis seufzt: "Das ist wie Bernd. Nur mit Syntax-Highlighting."',
            '🎪 Wigald Bohning interviewt die Editoren: "Vim, wie fühlt sich ewige Relevanz an?" Vim: ":q!" Wigald: "War das ein Ja?" Willy singt: "♪ Vi-Vi-Vi-Vi-Vim, der Editor so schliiiiimm ♪" Krappweis: "Können wir über Bernd reden? Bernd fühlt sich ausgeschlossen."',
            '🎤 Krappweis pitcht: "Ein Kastenbrot. Das programmieren kann. Aber nicht WILL. Es heißt... BERND DAS CODE-BROT." Willy: "BROT-GRAMMIEREN! CODE-BROT! BACK-END!" Wigald: "Und die IDE heißt BRÖT-CHEN." Alle schweigen. Dann Applaus.',
        ...
        boat: [
            ...
            '🕸️ "WWW-was?!" stottert Tim am Boot. "World Wide Web! Ich hab das 1989 erfunden! In der Mittagspause! Am CERN!" Python fragt: "Und dann?" Tim: "Dann hab ich es VERSCHENKT. Gratis. Für alle." Krabs fällt in Ohnmacht.',
