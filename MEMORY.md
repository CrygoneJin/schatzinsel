...
| Datum | Was | Warum gut |
|-------|-----|-----------|
| 2026-04-01 | Genesis-Tutorial (PR #158) — 7-Schritt Schöpfungsgeschichte als alternatives Onboarding | genesis.js existierte schon, fehlte nur die Integration in game.js (INSEL_GENESIS.run() statt showTutorialOnboarding bei ?genesis=1). Backlog #37. |
