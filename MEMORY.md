...
| 2026-04-03 | Sprint-Namenskonflikt zum dritten Mal — feat/sprint-25 hatte bereits Sprint 25+26 mit anderem Content | git fetch war gemacht, aber SPRINT.md auf dem Remote-Branch nicht gelesen | `git show origin/feat/sprint-N:SPRINT.md | head -5` vor jedem Sprint Planning — IMMER |
