...
| 2026-04-03 | Sprint 25 — Dungeon + Palette als Instrument live | dungeon.js (3-Raum IT-Dungeon: Bits/Kernel/Browser, click auf cave im Ernte-Modus). soundPaletteNote() in sound.js — jedes Material hat eine Note (C4-D5 für Basis-Elemente, Pentatonik-Hash für Rest). Wetter → weather.js extrahiert. game.js Hexvoxel-Merge hat Counter von 4210 auf 4975 getrieben — < 4000 braucht mehrere Sessions. |
| 2026-04-03 | Code nach return in IIFE läuft nicht | PALETTE_NOTES + soundPaletteNote nach return-Objekt definiert = unreachable. Fix: Funktion vor return definieren. | Immer prüfen ob Code in IIFE vor oder nach return ist. |
