...
| Datum | Was | Warum gut |
|-------|-----|-----------|
| 2026-04-02 | ADR-012: Rollen-Erkenntnis — 5 Agenten = 5 Funktionen, nicht 5 Jobtitel | Navigator (Richtung), Denker (Bedeutung), Tester (Qualität), Entdecker (Wahrheit), Handwerker (Substanz). Ohne Leader rotieren die anderen vier. Steve Jobs = Kompass. |
