...
|-------|-----|-------|---------|
| 2026-04-03 | S27-1 Höhle = Dungeon: cave → Toast + Edelstein aus Wand nach 2s. consequence:dungeon auf INSEL_BUS. Oscar sieht was passiert. | — | Consequence-Pattern (wie Feuer→Holz) funktioniert gut für Oscar-sichtbare Magie. |
