...
| Datum | Was | Warum gut |
|-------|-----|-----------|
| 2026-04-01 | Dungeon-Framework (PR #162) — 3-Akt Höhlen-Exploration (#50) | dungeon.js (350 LOC) als eigenes Modul. Random Walk Generation, Fog of War, Sokoban-Hindernisse, Fackel/Schalter/Tür-Mechanik. Integration in game.js: 4 Hooks (checkPlayerProximity, movePlayer, draw, keydown ESC). Saubere Schnittstelle via window.INSEL_DUNGEON. |
