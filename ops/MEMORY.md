...
| 2026-04-25 | Sprint Review S103: alle 4 Items done (IDB-Backup #494, Analytics #492, Quest-85 #453, Worktree-Codex #491). SPRINT.md auf main zeigte S103 als laufend obwohl wir real bei S111 sind (16+ offene ops-PRs nicht auf main gemergt). | SPRINT.md-Drift entsteht wenn ops-PRs nicht in Merge-Block enthalten sind. | Smoke-Test CF-403 + Worker-"Host not in allowlist" = bekannte Sandbox-Limitation, kein Issue erstellen. Ceremony-Sequenz wenn alle Items done: Daily überspringen → direkt Review. |
