...
| 2026-05-02 | S112 Retro + Merge-Guide (autonomer Agent): Smoke CF-403 + Worker "Host not in allowlist" — bekannte Sandbox-Limitation. Ceremony-Stand auf main: S112 Retro fehlte, jetzt geschrieben. Befund: 15+ offene PRs mit Duplikat-Ceremonies (S112 Retro 6×, Quest-Runde-95 6×, Hörspiel K17–K22 gestackt). Parallele Agents erzeugen Ceremony-Duplikate weil sie main-SPRINT.md unvollständig vorfinden und Retro/Planning selbst produzieren. Structural Fix: `gh pr list` vor Ceremony-Branch prüfen — bereits in #576 dokumentiert. **Till's Priorität:** #577 (Quest-Runde 95) + #576 (S112 Retro) direkt mergebar. Hörspiel: #568 → #570 → #571 → #574 → #578 → #580 in Reihenfolge. Duplikate schließen: #573 #575 #565 #566 #563 #564 #558 #572 #569 #567 #561. Nach #577-Merge: 975 Quests, neinhorn 75 · mephisto 74 · bug 75. |
