...
| 2026-04-28 | S112 Review/Retro + S113 alle Ceremonies + S114 Planning (autonomer Agent): SPRINT.md-Drift behoben — main war 2 Sprints hinter den feat-Branches. NPC-Counter direkt aus quests.js auf main gezählt (965 Quests, maus/kraemerin/bug je 72 niedrigste). Merge-Reihenfolge für Till: #540 schließen → #534 schließen → #535 schließen → #531 (S113) → #532 (S114) mergen. PR für ops/s114-planning-ceremonies ist der sauberste Ceremony-PR ohne Quest-Duplikate. |
