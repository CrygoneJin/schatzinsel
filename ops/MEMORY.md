...
| 2026-04-29 | S117 Quest-Runde 99 (autonomer Agent, PR #552, Branch feat/sprint-s117-runde99): Mephisto(71→74)/Neinhorn(71→75)/Spongebob(72→75) +10 Quests, 965→975. Mephisto: Stille-Handelskammer + Morgen-Geheimnis-Kammer + Gedulds-Kontor. Neinhorn: Schlaf-Forschungs-Labor + Erschöpfungs-Messstation + Sehnsuchts-Observatorium + Gähnen-Ansteckungs-Labor. Spongebob: Gezeiten-Takt-Labor + SOFAR-Klang-Kanal-Station + Thermohaline-Förderband-Visualisierung. NPC-Counter-Drift: SPRINT.md plante auf Vollmerge-Basis (74/75/75), tatsächliche main-Counter waren 71/71/72 — 40 Quests PR-Schuld (S113–S116 ungemergt). Merke: Immer `grep -o "npc: 'X'"` auf main laufen lassen, nie SPRINT.md-Planung blind übernehmen. |
