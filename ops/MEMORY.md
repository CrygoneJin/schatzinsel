...
| Datum | Was | Warum gut |
|-------|-----|-----------|
| 2026-04-04 | 9 PRs in einer Session (#217-#225) — höchste Produktivität bisher | Sprint 26 komplett + 6 Bonus-PRs. Parallel-Agenten für unabhängige Tasks (Taschentücher + Metrik-Audit). Alles atomar: ein Feature = ein Branch = ein PR. |
| 2026-04-04 | Feynman×Heidegger Metrik-Audit: `crafts_total` zählt `builds`, nicht Crafts | Feld-Name lügt. Webhook-Payload muss umbenannt werden. Engagement Score ist binär statt Gradient. Neutrino Score bestraft stille Spieler. |
| 2026-04-04 | itch.io: 640×480 → 960×600 nach Team-Debatte | Canvas ist responsive, braucht Platz. Scrollbars AUS (Canvas scrollt nicht). Landscape statt Default. $5 Anker statt $3. |
| 2026-04-04 | Stripe MCP steht — ?danke=1 Toast gebaut bevor Payment Link existiert | Rückwärts arbeiten: erst den Empfang bauen, dann den Sender. Toast wartet auf Payment Link. |
