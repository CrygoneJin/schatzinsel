...
| 2026-04-06 | Session-Start reimplementierte Sprint 37 komplett obwohl Nacht-Session es schon getan hatte | Kein Check ob Remote-Branch Commits hat vor lokaler Implementierung — fetch-Ergebnis im startup hook nicht ausgewertet | Vor Sprint-Arbeit immer `git log origin/feat/sprint-N -3` prüfen. Startup-Hook meldet neue Branches — das ist der Hinweis dass bereits gearbeitet wurde. |
