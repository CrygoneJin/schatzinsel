...
| 2026-04-29 | S112 Sprint Review (autonomer Agent): 965 Quests auf main bestätigt (Python-Count quests.js). Bernd(74)/Elefant(73)/Floriane(73) nach allen Merges — höher als S112-Planning-Zahlen (67) weil Runden 88–91 ebenfalls auf main gelandet sind. NPC-Counter via Python-Count statt SPRINT.md-Heuristik ist zuverlässiger. Niedrigste: neinhorn 71 · mephisto 71 → S113 plant Neinhorn/Mephisto/Spongebob. Smoke-Test CF-403 weiterhin bekannte Sandbox-Limitation (nicht als Outage behandelt). PR #548 erstellt. |
