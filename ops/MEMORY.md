...
| 2026-04-29 | PR-Stack akkumuliert: 6 Quest-PRs + 5+ Ceremony-PRs offen, alle auf main-Basis → Quest-Counter-Konflikte beim Merge | Autonome Sessions erstellen neue PRs ohne zu prüfen ob ältere noch offen — merge order geht verloren | Vor neuer Quest-Runde: `gh pr list` prüfen. Wenn >3 Quest-PRs offen → Till zuerst mergen lassen. Merge-Reihenfolge explizit im Daily Scrum dokumentieren (#553). Duplikate identifizieren (PR #552 = Duplikat von #550). |
