...
| 2026-04-03 | S25-2 Phantom-Open: Dungeon war vollständig in Commit #181. Backlog zeigte 🔲. | Kein Update nach Commit. | Nach jedem Feature-Commit sofort BACKLOG.md + SPRINT.md updaten, nicht erst bei Ceremony. |
| 2026-04-03 | S25-3: NPC_VOICES+4 Konstanten → npc-data.js (window.INSEL_NPC_DATA). game.js: 5196→5136. | TEMPLATES als function()-Array statt Arrow wegen IIFE-Stil-Konsistenz. | Arrow-Functions in IIFE-Exports sind fine — hätte Arrow behalten können, function() unnötig. |
